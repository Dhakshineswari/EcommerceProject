...
function placeOrderHandler(){
    ...
    return ( cartItems.length>0?  <Fragment>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                        <div className="stockCounter d-inline">
                                            ...
                                            <span className="btn btn-primary plus" onClick={()=> increaseOty(item)}>+</span>
                                        </div>
                                    </div>
        ...
        </div></Fragment> : (!complete ? <h2 className="mt-5">your cart is empty</h2> 
        : <Fragment>
